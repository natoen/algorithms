const bind = (func, context, ...args1) => (...args2) => func.apply(context, args1.concat(args2));

function examplefunc(a, b) { return a + b; }
const boundFunc = bind(examplefunc, null, 'diet');
boundFunc('coke'); // 'dietcoke'


Function.prototype.bind = function (context, ...args1) {
  const func = this;
  return (...args2) => func.apply(context, args1.concat(args2));
};
...
This will be similar to your first solution, but should be able to be used in the following way:
